...
@Component
@AllArgsConstructor
public class FindJoinedEvents {

    private final EventsRepository eventsRepository;
    private EventToResponse eventToResponse;


    public List<EventResponseDTO> findJoinedEvents(Long id) {
        return eventToResponse.convertListToResponse(eventsRepository.findByEventParticipants_Id(id));
    }
